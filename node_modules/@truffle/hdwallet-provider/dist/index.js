...
class HDWalletProvider {
    constructor(mnemonic, provider, addressIndex = 0, numAddresses = 10, shareNonce = true, walletHdpath = `m/44'/60'/0'/0/`) {
        ...
        const checkBIP39Mnemonic = (mnemonic) => {
            this.hdwallet = hdkey_1.default.fromMasterSeed(bip39.mnemonicToSeedSync(mnemonic));
        ...
        if (typeof provider === "string") {
            ...
            switch (providerProtocol) {
                case "ws:":
                case "wss:":
                    this.engine.addProvider(new websocket_1.default({ rpcUrl: provider }));
                    break;
                default:
                    this.engine.addProvider(new rpc_1.default({ rpcUrl: provider }));
            }
        }
        else {
